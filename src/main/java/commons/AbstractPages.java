...
public class AbstractPages {
	...
	public void selectItemInDropdown(WebDriver driver, String locatorXpath, String valueSelect, String... values) {
		locatorXpath = String.format(locatorXpath, (Object[]) values);
		element = driver.findElement(By.xpath(locatorXpath));
		Select select = new Select(element);
	...
	public String getAtributeValue(WebDriver driver, String locatorXpath, String atributeName, String...values) {
		locatorXpath = String.format(locatorXpath, (Object[]) values);
		element = driver.findElement(By.xpath(locatorXpath));
		return element.getAttribute(atributeName);
	}
	...
	public String getErrorMsgOnProductInCard(WebDriver driver, String dynamicProduct) {
		...
		return getTextOfElement(driver, AbstractPageUI.DYNAMIC_ERROR_MSG_ON_PRODUCT_IN_CARD, dynamicProduct);
	...
	public void clickToDynamicAddToCard_CompareLink(WebDriver driver, String value01, String value02) {
	...
	public String getDynamicNavBarProductName(WebDriver driver, String dynamicProductName) {
		return getTextOfElement(driver, AbstractPageUI.DYNAMIC_NAVMENU_PRODUCT_NAME, dynamicProductName);
	}
	...
	public void clickToDynamicAddUpdateBtnInWishList_ForOneProduct(WebDriver driver, String productItem,
			String productButton) {
		highlightElement(driver, AbstractPageUI.DYNAMIC_BUTTON_ADD_UPDATE_IN_WIISHLIST_ONE_PRODUCT, productItem,
				productButton);
		clickToElement(driver, AbstractPageUI.DYNAMIC_BUTTON_ADD_UPDATE_IN_WIISHLIST_ONE_PRODUCT, productItem,
				productButton);
	}
	...
	public void selectDynamicDropdownInAction_BE(WebDriver driver, String valueExpected, String parent) {
		selectItemInCustomDropdown(driver, AbstractPageUI.DYNAMIC_ACTION_DDROPDOWN_CUSTOMER_MANAGE_PARENT,
	...
	public void selectItemInDynamicDropdown(WebDriver driver, String valueExpected, String parent) {
		selectItemInDropdown(driver, AbstractPageUI.DYNAMIC_DROPDOWN_PARENT, AbstractPageUI.DYNAMIC_DROPDOWN_CHILD,
